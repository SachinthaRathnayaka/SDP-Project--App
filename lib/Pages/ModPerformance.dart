...
class VehicleModificationPartsScreen extends StatefulWidget {
  const VehicleModificationPartsScreen({Key? key}) : super(key: key);

  @override
  State<VehicleModificationPartsScreen> createState() => _VehicleModificationPartsScreenState();
}

class _VehicleModificationPartsScreenState extends State<VehicleModificationPartsScreen> {
